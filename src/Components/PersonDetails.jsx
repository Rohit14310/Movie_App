...
function PersonDetails() {
  ...
  return info ? (
    <div className="px-[3%] w-screen bg-[#1F1E24] ">
      {/* Part-1 navigation */}
      ...
      <div className="w-full flex ">
        <div className="w-[20%] ">
          <img
            className="shadow-[8px_17px_38px_2px_rgba(0,0,0,.5)]  object-cover rounded-xl"
        ...
        <div className="w-[75%] ml-[5%]">
          <h1 className="text-6xl text-zinc-400 font-black my-4">
            {info.detail.name}
          </h1>
              ...
              >
                <Link to={`/${category}/details/${c.id}`} className="">
                  ...
                  <span className="block ml-5 mt-2">
                    Character Name:{c.character && `character: ${c.character}`}
                  </span>
                </Link>
              </li>
            ))}
